                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="start_date" name="start_date" value="<?= htmlspecialchars($tour['start_date'] ?? '') ?>">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="location" name="location" placeholder="e.g., Phuket, Thailand" value="<?= htmlspecialchars($tour['location'] ?? '') ?>">
